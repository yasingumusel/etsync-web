...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Automatic currency conversion" },
      { label: "Sync on demand" },
      { label: "Automatic sync every 6 hours" },
      { label: "“View on Etsy” link on every product" },
      { label: "Preview changes before syncing", soon: true },
      { label: "Email support" },
    ],
  },
  {
    ...
    features: [
      ...
      { label: "“View on Etsy” link on every product" },
      { label: "Preview changes before syncing", soon: true },
      { label: "Sync history and failure alerts", soon: true },
      { label: "Email support" },
    ],
  },
  {
    ...
    features: [
      ...
      { label: "Automatic currency conversion" },
      { label: "Sync on demand" },
      { label: "Automatic sync every 2 hours" },
      { label: "“View on Etsy” link on every product" },
      { label: "Preview changes before syncing", soon: true },
      { label: "Sync history and failure alerts", soon: true },
      { label: "Etsy reviews on your product pages", soon: true },
